class Ruax {
	...
	_getValidationConfig(config) {
		...
		//type请求方式post/get
		if ((typeof config.type != "string") || ((config.type.toLocaleUpperCase() != 'POST') && (config.type
				.toLocaleUpperCase() !=
				'GET'))) {
		...
		//dataType返回参数类型
		if ((typeof config.dataType != "string") || ((config.dataType.toLocaleUpperCase() != "STRING") &&
				(config.dataType.toLocaleUpperCase() != "XML") && (config.dataType.toLocaleUpperCase() != "HTML") &&
				(config.dataType.toLocaleUpperCase() != "JSON") && (config.dataType.toLocaleUpperCase() !=
				"BLOB") &&
	...
	_setDefaults() {
		...
		//type请求方式post/get
		if ((typeof this.defaults.type != "string") || ((this.defaults.type.toLocaleUpperCase() != 'POST') && (this
				.defaults.type
				.toLocaleUpperCase() != 'GET'))) {
		...
		if ((typeof this.defaults.dataType != "string") || ((this.defaults.dataType.toLocaleUpperCase() !=
				"STRING") &&
				(this.defaults.dataType.toLocaleUpperCase() != "XML") && (this.defaults.dataType
				.toLocaleUpperCase() != "HTML") &&
				(this.defaults.dataType.toLocaleUpperCase() != "JSON") && (this.defaults.dataType
				.toLocaleUpperCase() != "BLOB") &&
				...
				if (xhr.readyState == 4) {
					...
					if (xhr.status == 200) {
						...
						if (config.dataType.toLocaleLowerCase() == "json") {
							...
							res = xhr.responseXML;
						} else if (config.dataType.toLocaleLowerCase() == "html" || config.dataType ==
							"string") {
