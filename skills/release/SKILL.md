---
name: release
description: ruax 发布流程，按步骤完成版本号更新、源码打包、文档更新、changelog 更新、文档打包、README 更新、npm 发布，每步均需用户确认后执行。
---
...
- `src/index.ts`：所有对外导出的类、函数、类型定义、构造参数、实例方法、静态方法的真实签名

### 3.2 逐项核查文档

对 `docs/` 目录下以下文件逐一核查：

- `docs/index.md`：首页介绍内容
- `docs/guide/introduction.md`：库的介绍说明
- `docs/guide/install.md`：安装方式
- `docs/guide/quick-start.md`：快速上手示例
- `docs/guide/attrs.md`：配置项/属性文档
- `docs/guide/apis.md`：API 方法文档
...
6. **配置项**：列出主要的构造参数或配置选项（取自 `docs/guide/attrs.md`），附简要说明
7. **API 方法**：列出核心实例方法和静态方法（取自 `docs/guide/apis.md`），附简要说明
8. **文档链接**：完整文档地址
9. **License**
